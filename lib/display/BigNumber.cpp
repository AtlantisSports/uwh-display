...
{   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    ...
    _,   _, 0xF, 0xF,   _,   _,   _,   _,   _,   _,   _,  BR, 0xF, 0xF,   _,   _,
    _,   _, 0xF, 0xF,   _,   _,   _,   _,   _,   _,  BR, 0xF, 0xF, 0xF,   _,   _,
    _,   _, 0xF, 0xF,   _,   _,   _,   _,   _,  BR, 0xF, 0xF, 0xF, 0xF,   _,   _,
    _,   _, 0xF, 0xF,   _,   _,   _,   _,  BR, 0xF, 0xF,  NW, 0xF, 0xF,   _,   _,
    _,   _, 0xF, 0xF,   _,   _,   _,  BR, 0xF, 0xF,  NW,   _, 0xF, 0xF,   _,   _,
    _,   _, 0xF, 0xF,   _,   _,  BR, 0xF, 0xF,  NW,   _,   _, 0xF, 0xF,   _,   _,
    _,   _, 0xF, 0xF,   _,  BR, 0xF, 0xF,  NW,   _,   _,   _, 0xF, 0xF,   _,   _,
    _,   _, 0xF, 0xF,  BR, 0xF, 0xF,  NW,   _,   _,   _,   _, 0xF, 0xF,   _,   _,
    _,   _, 0xF, 0xF, 0xF, 0xF,  NW,   _,   _,   _,   _,   _, 0xF, 0xF,   _,   _,
    _,   _, 0xF, 0xF, 0xF,  NW,   _,   _,   _,   _,   _,   _, 0xF, 0xF,   _,   _,
...
{   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    ...
    _,   _,   _,   _,  SE, 0xF,  TL, 0xF, 0xF,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _,  SE, 0xF,  TL,   _, 0xF, 0xF,   _,   _,   _,   _,   _,   _,   _,
...
{   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _,   _,   _,  BR, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF,  SW,   _,   _,   _,
    _,   _,   _,   _,  BR, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF,   _,   _,   _,
    _,   _,   _,  BR, 0xF,  TL,   _,   _,   _,   _,  RT, 0xF, 0xF,   _,   _,   _,
    _,   _,   _, 0xF,  TL,   _,   _,   _,   _,   _,  RT, 0xF, 0xF,   _,   _,   _,
    _,   _,   _,   _,   _,   _,   _,   _,   _,   _,  BR, 0xF, 0xF,   _,   _,   _,
    _,   _,   _,   _,   _,   _,   _,   _,   _,  BR, 0xF, 0xF,  NW,   _,   _,   _,
    _,   _,   _,   _,   _,   _,   _,   _,  BR, 0xF, 0xF,  NW,   _,   _,   _,   _,
    _,   _,   _,   _,   _,   _,   _,  BR, 0xF, 0xF,  NW,   _,   _,   _,   _,   _,
    _,   _,   _,   _,   _,   _,  BR, 0xF, 0xF,  NW,   _,   _,   _,   _,   _,   _,
    _,   _,   _,   _,   _,  BR, 0xF, 0xF,  NW,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _,   _,  BR, 0xF, 0xF,  NW,   _,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _,  BR, 0xF, 0xF,  NW,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF,   _,   _,   _,
    _,   _,   _, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF,   _,   _,   _,
    _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _ };
...
{   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _,   _,   _,  SE, 0xF,  TL,   _,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _,   _,  SE, 0xF,  TL,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _,  SE, 0xF,  TL,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _, 0xF, 0xF,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _, 0xF, 0xF,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _, 0xF, 0xF,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF, 0xF,  SW,   _,   _,   _,   _,
...
void BigNumber::RenderQuarterSingle(Canvas *Canvas,
                                    unsigned Display,
                                    unsigned Value,
                                    unsigned X, unsigned Y,
                                    const Color &FG,
  ...
  for (unsigned y = 0; y < 8; y++) {
    for (unsigned x = 0; x < 8; x++) {
      if (Numbers32x32[Value][x * 2 + y * 2 * 16]) {
        Canvas->SetPixel(xoffs + x, yoffs + y, FG.r, FG.g, FG.b);
      } else if (BG) {
        Canvas->SetPixel(xoffs + x, yoffs + y, BG->r, BG->g, BG->b);
      }
...
void BigNumber::RenderQuarterDouble(Canvas *Canvas,
                                    unsigned Display,
                                    unsigned Value,
                                    unsigned X, unsigned Y,
                                    const Color &FG,
  ...
  for (unsigned y = 0; y < 8; y++) {
    for (unsigned x = 0; x < 4; x++) {
      if (Tens != 0 && Numbers16x32[Tens][x * 2 + y * 2 * 8]) {
        Canvas->SetPixel(xoffs + x, yoffs + y, FG.r, FG.g, FG.b);
      } else if (BG) {
        Canvas->SetPixel(xoffs + x, yoffs + y, BG->r, BG->g, BG->b);
      }
  ...
  for (unsigned y = 0; y < 8; y++) {
    for (unsigned x = 0; x < 4; x++) {
      if (Numbers16x32[Ones][x * 2 + y * 2 * 8]) {
        Canvas->SetPixel(xoffs + x, yoffs + y, FG.r, FG.g, FG.b);
      } else if (BG) {
        Canvas->SetPixel(xoffs + x, yoffs + y, BG->r, BG->g, BG->b);
      }
