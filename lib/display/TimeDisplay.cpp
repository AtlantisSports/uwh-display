...
{   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    ...
    _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,
    _, 0xF, 0xF, 0xF,   _, 0xF,   _, 0xF,   _, 0xF, 0xF, 0xF,   _, 0xF,  BL,   _,
    _, 0xF,   _, 0xF,   _, 0xF,   _, 0xF,   _, 0xF,   _,   _,   _, 0xF,  TL,   _,
    _, 0xF,   _, 0xF,   _, 0xF,   _, 0xF,   _, 0xF, 0xF,   _,   _, 0xF,   _,   _,
    _, 0xF,   _, 0xF,   _, 0xF,   _, 0xF,   _, 0xF,   _,   _,   _, 0xF,  BL,   _,
    _, 0xF, 0xF, 0xF,   _,  TR, 0xF,  TL,   _, 0xF, 0xF, 0xF,   _, 0xF,  TR,   _,
    _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _ };
#undef _
